  ...
  return (
    <section className="mainSection" id="mainSection">
      ...
      >
        ...
        <p>
          Мы будем работать с чувством подавленности, чтобы помочь тебе обрести
          понимание, развить силу и навыки совладания, чтобы предоставить тебе
          инструменты для управления сложными эмоциями, межличностными
          отношениями и жизненными переменами.
        </p>
      </div>
